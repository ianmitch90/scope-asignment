...
/*************************************************************************************
------------ ANSWER -------------------
x will print out since the log(y) is outside the function will print nothing since it isnet defined, and then run the function and print log(x)
**************************************************************************************/
...
/*************************************************************************************
------------ ANSWER -------------------
so var x will be hoisted up to give warmup context
warmup function would log the value of x but not be able to give the log for foo seeing as its in another function and cant get hoisted outside of warmup
**************************************************************************************/
...
/**************************************************************************************
------------ ANSWER -------------------
so ifees work like walled gardens in that the first log will print out 4
but outside of the function it would be undefined becuase theres no global or local refrence to "add"
**************************************************************************************/
...
(function(){
  "use strict";
  var birthday = Thu April 21 1983;
